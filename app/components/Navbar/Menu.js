...
export default function MyDropdown({
  ...
  return (
    <div className="text-right  relative z-[999]">
      {authenticated ? (
        <Menu as="div" className="relative inline-block text-left">
          ...
          items-center text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 font-serif capitalize"
            >
