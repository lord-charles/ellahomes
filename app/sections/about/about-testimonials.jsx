...
import { _testimonials } from "@/app/_mock";
...
export default function AboutTestimonials() {
    ...
    >
      ...
      <m.div variants={varFade().inUp}>
        <Typography sx={{ color: "common.white" }}>
          Our goal is to cater to individuals who appreciate quality
          accommodations and value affordability, regardless of their financial
          status. We strive to exceed the expectations of even the most affluent
          guests, offering a sanctuary of luxury and refinement amidst the
          vibrant energy of Nyali.
        </Typography>
      </m.div>
    </Box>
  );
  ...
  return (
    <Box
      sx={{
        ...bgGradient({
          color: alpha(theme.palette.grey[900], 0.93),
